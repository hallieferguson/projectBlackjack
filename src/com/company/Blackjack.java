 ...
 * modified by: Hallie Ferguson, hferguson@student.bridgew.edu. April 2020
 */
...
public class Blackjack {
     ...
     */
    private static void dealCard(Deck deck, BlackjackHand blackjackHand) {
        ...
        blackjackHand.addCard(deck.dealCard()); // Deal a card from the deck, and add it to the hand.
    }
    ...
    private static void printResult(BlackjackHand playerHand, BlackjackHand dealerHand) {
        ...
        else if (playerHand.getBlackjack() == true) {
     ...
     */
    private static void displayHands(BlackjackHand dealerHand, BlackjackHand playerHand) {
